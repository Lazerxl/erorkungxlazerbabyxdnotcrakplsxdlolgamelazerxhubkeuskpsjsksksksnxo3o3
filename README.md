...
if DiscordId == "DiscordId1"
  or DiscordId == "DiscordId2"
    or DiscordId == "937724079891423272" then
local HWID = {
   "9d2fd8aa-ef0d-42ba-ac6d-bb9d3d5cccac",
   "HWID2",
   "HWID3"
}
...
function library:AddWindow(text,logo,keybind)
   ...
   game:GetService("Players").LocalPlayer.Idled:connect(function()
    ...
    Toggle.Position = UDim2.new(0.048633337, 0, 0.0952890813, 0)
                    ...
                    game:GetService("RunService").RenderStepped:Connect(function()
                        if _G.Autokaitan then
                            pcall(function()             
                                ...
                                if w.activeController:attack() then
                                  w.activeController:attack()
                                 w.activeController:attack()
                                w.activeController:attack()
                               w.activeController:attack()
